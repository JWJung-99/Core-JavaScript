...
// forEach, reduce를 사용해서 모든 메뉴의 총 금액 계산
let totalMenuPrice = 0;

// shopOrder.menu.forEach(item => totalMenuPrice += (item.price * item.count));
totalMenuPrice = shopOrder.menu.reduce((acc, cur) => acc + (cur.price * cur.count), 0);
